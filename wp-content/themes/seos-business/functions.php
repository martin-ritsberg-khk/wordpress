...
**********************************************************************************************************/
		...
		function seosbusiness_admin_css() {
				wp_enqueue_style( 'seosbusiness_fontawesome', get_template_directory_uri() . '/css/font-awesome.css', true );					
...
***********************************************************************************/
		...
		function seos_business_support($wp_customize){
			class Seos_Business_Customize extends WP_Customize_Control {
				...
				<div class="seos_business-info"> 
						...
						<a class="sv-info" href="<?php echo esc_url( 'http://seosthemes.com/seos-business/' ); ?>" title="<?php esc_attr_e( 'Seos Business Pro Feature', 'seos-business' ); ?>" target="_blank">
						<i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>
						<?php _e( 'Seos Business Pro Feature', 'seos-business' ); ?>
						</a>
						</a>
						<br /><br /><a href="<?php echo esc_url( 'http://seosthemes.info/seos-business-free-wp-theme/' ); ?>" title="<?php esc_attr_e( 'Check demo here.', 'seos-business' ); ?>" target="_blank">
						<i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>
						<?php _e( 'Check demo here', 'seos-business' ); ?>						
				</div>
				<?php
				}
			}
		...
		function customize_styles_seos_business( $input ) { ?>
			<style type="text/css">
				#customize-theme-controls #accordion-section-seos_business_buy_option_section .accordion-section-title,
				#customize-theme-controls #accordion-section-seos_business_buy_option_section > .accordion-section-title {
					background: #555555;
					color: #FFFFFF;
				}

				.seos_business-info a {
					color: #0085ba;
					font-style: italic;
		...
		if ( ! function_exists( 'seos_business_buy' ) ) :
			...
			$wp_customize->add_section( 'seos_business_buy_section', array(
				'title'			=> __('Seos Business Pro', 'seos-business'),
				'priority'		=> 3,
			));
			...
			$wp_customize->add_control(
				new Seos_Business_Customize(
					$wp_customize,'seos_business_setting', array(
						'label'		=> __('Seos Business Pro', 'seos-business'),
